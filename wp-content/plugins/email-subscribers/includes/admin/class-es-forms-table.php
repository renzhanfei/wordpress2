...
class ES_Forms_Table extends WP_List_Table
{
    ...
    elseif ('edit' === $action) {
        ...
        <h1 class="wp-heading-inline"><?php _e('Forms', 'email-subscribers') ?><a
                    href="admin.php?page=es_forms&action=new" class="page-title-action"> <?php _e(
                    'Add New',
                    'email-subscribers'
                ) ?></a></h1>
    ...
    public function es_new_form_callback()
    {
        ...
        if ('submitted' === $submitted) {
            ...
            $validate_data = [
                ...
                'lists' => !empty($form_data['lists']) ? $form_data['lists'] : [],
            ];
    ...
    public function prepare_list_form($id = 0, $data = [])
    {
        ...
        $form_data['email_visible']  = !empty($data['email_visible']) ? $data['email_visible'] : 'no';
        $form_data['email_required'] = !empty($data['email_required']) ? $data['email_required'] : 'no';
        $form_data['button_label']  = !empty($data['button_label']) ? $data['button_label'] :
            __('Subscribe', 'email-subscribers');
        $form_data['list_visible']  = !empty($data['list_visible']) ? $data['list_visible'] : 'no';
        $form_data['lists']         = !empty($data['lists']) ? $data['lists'] : [];
            ...
            <div id="poststuff">
                <div id="post-body" class="metabox-holder column-1">
                    <div id="post-body-content">
                        <div class="meta-box-sortables ui-sortable">
                            <form method="post"
                                  action="admin.php?page=es_forms&action=<?php echo $action; ?>&form=<?php echo $id; ?>&_wpnonce=<?php echo $nonce; ?>">
                                <table class="form-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="form_data[name]" id="ig_es_title"
                                                   value="<?php echo stripslashes($form_data['name']); ?>" size="30"
                                                   maxlength="100"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="form_data[desc]" id="ig_es_title"
                                                   value="<?php echo stripslashes($form_data['desc']); ?>" size="30"
                                                   maxlength="100"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <table class="">
                                                ...
                                                <tr class="form-field">
                                                    ...
                                                    <td><input type="checkbox" class="" name="form_data[email_visible]"
                                                               value="yes" <?php if ($form_data['email_visible']
                                                                                     === 'yes') {
                                                            echo 'checked="checked"';
                                                        } ?> ></td>
                                                    <td><input type="checkbox" class="" name="form_data[email_required]"
                                                               value="yes" <?php if ($form_data['email_required']
                                                                                     === 'yes') {
                                                            echo 'checked="checked"';
                                                        } ?> ></td>
                                                    <td><input type="text" class="" name="form_data[email_label]"
                                                               value="<?php echo $form_data['email_label']; ?>"></td>
                                                </tr>
                                                <tr class="form-field">
                                                    <td><?php _e('Name', 'email-subscribers'); ?></td>
                                                    <td><input type="checkbox" class="es_visible"
                                                               name="form_data[name_visible]"
                                                               value="yes" <?php if ($form_data['name_visible']
                                                                                     === 'yes') {
                                                            echo 'checked="checked"';
                                                        } ?> /></td>
                                                    <td><input type="checkbox" class="es_required"
                                                               name="form_data[name_required]"
                                                               value="yes" <?php if ($form_data['name_required']
                                                                                     === 'yes') {
                                                            echo 'checked=checked';
                                                        } ?>></td>
                                                    <!-- <td> <input type="text" class="es_name_label" name="form_data[name_label]"  value="<?php echo $form_data['name_label']; ?>" <?php if ($form_data['name_required']
                                                                                                                                                                                               === 'yes') {
                                                ...
                                                <tr class="form-field">
                                                    ...
                                                    <td><input type="checkbox" class="" name="form_data[button_visible]"
                                                               value="yes" disabled="disabled" checked="checked"></td>
                                                    <td><input type="checkbox" class=""
                                                               name="form_data[button_required]" value="yes"
                                                               disabled="disabled" checked="checked"></td>
                                                    <td><input type="text" class="" name="form_data[button_label]"
                                                               value="<?php echo $form_data['button_label']; ?>"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            ...
                                            <p class="helper"> <?php _e(
                                                    'Contacts will be added into selected list(s)',
                                                    'email-subscribers'
                                                ); ?></p>
                                        </th>
                                        <td>
                                            ...
                                            if (count($lists) > 0) {
                                                ...
                                                echo ES_Shortcode::prepare_lists_checkboxes(
                                                    $lists,
                                                    array_keys($lists),
                                                    3,
                                                    (array)$form_data['lists']
                                                );
                                                ...
                                                <span><?php _e(
                                                        sprintf(
                                                            'List not found. Please <a href="%s">create your first list</a>.',
                                                            $create_list_link
                                                        )
                                                    ); ?></span>
                                            <?php } ?>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label for="tag-link"><?php echo __(
                                                    'Allow contact to choose list(s)',
                                                    'email-subscribers'
                                                ); ?></label>
                                            <p class="helper"> <?php _e(
                                                    'Allow contacts to choose list(s) in which they want to subscribe.',
                                                    'email-subscribers'
                                                ); ?></p>
                                        </th>
                                        <td>
                                            <input type="radio" name="form_data[list_visible]"
                                                   value="yes" <?php if ($form_data['list_visible'] === 'yes') {
                                                echo 'checked="checked"';
                                            } ?> /><?php _e('Yes', 'email-subscribers'); ?>

                                            <input type="radio" name="form_data[list_visible]"
                                                   value="no" <?php if ($form_data['list_visible'] === 'no') {
                                                echo 'checked="checked"';
                                ...
                                <input type="hidden" name="form_data[af_id]"
                                       value="<?php echo $form_data['af_id']; ?>"/>
                                ...
                                <?php }
                                    ...
                                    $message        = __(
                                        sprintf(
                                            'List(s) not found. Please create a first list from <a href="%s">here</a>',
                                            $lists_page_url
                                        ),
                                        'email-subscribers'
                                    );
                                ...
                                ?>
                                <div style=" background-image: linear-gradient(-100deg, rgba(250, 247, 133, 0.4), rgba(250, 247, 133, 0.8) 95%, rgba(250, 247, 133, 0.2)); padding: 10px; width: 35%; border-radius: 1em 0 1em 0; "><?php echo sprintf(
                                        __(
                                            'Secure your form and avoid spam signups with Email Subscribers Starter Plan <a target="_blank" style="font-weight: bold; cursor:pointer; text-decoration:none" href="%s">Get started</a>',
                                            'email-subscribers'
                                        ),
                                        $url
                                    ) ?></div>
    ...
    public function save_form($id, $data)
    {
        ...
        if (!empty($id)) {
            ...
            $return                  = $wpdb->update(IG_FORMS_TABLE, $form_data, ['id' => $id]);
        }
        else {
    ...
    public static function prepare_form_data($data)
    {
        ...
        $email_visible  = (!empty($data['email_visible']) && $data['email_visible'] === 'yes') ? true : false;
        $email_required = (!empty($data['email_required']) && $data['email_required'] === 'yes') ? true : false;
        $list_visible   = (!empty($data['list_visible']) && $data['list_visible'] === 'yes') ? true : false;
        $list_requried  = true;
        $list_ids       = !empty($data['lists']) ? $data['lists'] : [];
    ...
    public static function get_form_data_from_body($data)
    {
        ...
        $form_data = ['form_id' => $id, 'name' => $name, 'af_id' => $af_id, 'desc' => $desc];
        foreach ($body_data as $d) {
            ...
            elseif ($d['id'] === 'lists') {
                ...
                $form_data['lists']         = !empty($d['params']['values']) ? $d['params']['values'] : [];
            }
            elseif ($d['id'] === 'email') {
                $form_data['email_label'] = !empty($d['params']['label']) ? $d['params']['label'] : '';
                $form_data['email_visible']  = ($d['params']['show'] === true) ? 'yes' : '';
                $form_data['email_required'] = ($d['params']['required'] === true) ? 'yes' : '';
            }
            elseif ($d['id'] === 'submit') {
    ...
    public function delete_list($ids)
    {
        ...
        $query        = $wpdb->prepare($query, [$current_date]);
        $wpdb->query($query);
    }
    ...
    function column_name($item)
    {
        ...
        $actions = [
            'edit'   => sprintf(
                __('<a href="?page=%s&action=%s&form=%s&_wpnonce=%s">Edit</a>', 'email-subscribers'),
                esc_attr(Email_Subscribers::get_request('page')),
                'edit',
                absint($item['id']),
                $list_nonce
            ),
            'delete' => sprintf(
                __(
                    '<a href="?page=%s&action=%s&form=%s&_wpnonce=%s" onclick="return checkDelete()">Delete</a>',
                    'email-subscribers'
                ),
                esc_attr(Email_Subscribers::get_request('page')),
                'delete',
